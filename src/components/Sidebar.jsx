...
const s = {
  ...
  label: {
    fontSize: 9.5, fontWeight: 500, letterSpacing: '.07em', color: 'var(--tx3)',
    textTransform: 'uppercase', padding: '10px 8px 3px', whiteSpace: 'nowrap',
  },
  item: (active) => ({
...
const ITEMS = [
  { section: 'Focus', items: [
    ...
    { label: 'This week',  dot: '#3B6D11', view: 'calendar'  },
  ]},
  { section: 'Campaigns', items: [
    { label: 'Airbnb',              dot: '#185FA5', view: 'campaigns' },
    { label: 'Crexi',               dot: '#3B6D11', view: 'campaigns' },
    { label: 'Purrrmitted Living',  dot: '#854F0B', view: 'campaigns' },
    { label: "Data's User Journey", dot: '#534AB7', view: 'campaigns' },
  ]},
  { section: 'Workstreams', items: [
    { label: 'Automation',   dot: '#0F6E56', view: 'overview' },
    { label: 'RevOps',       dot: '#993C1D', view: 'overview' },
    { label: 'SEO / Content',dot: '#888780', view: 'overview' },
    { label: 'Website v2',   dot: '#D4537E', view: 'overview' },
  ]},
]
