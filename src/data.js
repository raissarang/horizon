...
export const INITIAL_CAMPAIGNS = [
  {
    id: 1,
    name: 'Airbnb campaign',
    tasks: [
      { id: 1, title: 'Blog posts (4 articles)', status: 'done', notes: 'Articles 4-7 drafted. Renter blog + B2B blog pending scheduling.', date: '2026-04-10' },
      { id: 2, title: 'Newsletter + thought leadership', status: 'in-progress', notes: 'Schedule Apr 13. Isolate proptech segment for TL send.', date: '2026-04-13' },
      { id: 3, title: 'B2C email (Sendgrid)', status: 'blocked', notes: 'Confirm launch date with Nikolay before sending.', date: '2026-04-15' },
    ],
  },
  {
    id: 2,
    name: 'Crexi whitepaper',
    tasks: [
      { id: 1, title: 'Whitepaper live', status: 'done', notes: 'Blog, LinkedIn, newsletter all published.', date: '2026-03-23' },
      { id: 2, title: 'Jonas quote design', status: 'todo', notes: 'Create graphic and confirm with Allyse.', date: '2026-04-24' },
    ],
  },
]
